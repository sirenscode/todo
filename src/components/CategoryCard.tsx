...
const CategoryCard: React.FC = () =>{
    return(
        <div className="flex flex-row flex-wrap w-3/4 items-left">
            <Link href={"/all"} className="w-[250px] h-[150px] flex bg-[#F9F9F9] shadow-lg shadow-[#fafafa] flex-col items-center justify-center border-[#9BECE1] border-[1px] rounded-lg gap-[10px] m-[10px] cursor-pointer transition duration-100 ease-in hover:bg-[#9BECE1] hover:shadow-[lightgray] hover:shadow-md">
            ...
            <Link href={"/tasks?where=personal"} className="w-[250px] h-[150px] flex bg-[#fafafa] flex-col shadow-lg shadow-[#fafafa] items-center justify-center border-[#9BECE1] border-[1px] rounded-lg gap-[10px] m-[10px] cursor-pointer transition duration-300 ease-in hover:bg-[#9BECE1] hover:shadow-[lightgray] hover:shadow-md">
            ...
            <Link href={"/tasks?where=grocery"} className="w-[250px] h-[150px] flex bg-[#fafafa] flex-col shadow-lg shadow-[#fafafa] items-center justify-center border-[#9BECE1] border-[1px] rounded-lg gap-[10px] m-[10px] cursor-pointer transition duration-300 ease-in hover:bg-[#9BECE1] hover:shadow-[lightgray] hover:shadow-md">
            ...
            <Link href={"/tasks?where=school"} className="w-[250px] h-[150px] flex bg-[#fafafa] flex-col shadow-lg shadow-[#fafafa] items-center justify-center border-[#9BECE1] border-[1px] rounded-lg gap-[10px] m-[10px] cursor-pointer transition duration-300 ease-in hover:bg-[#9BECE1] hover:shadow-[lightgray] hover:shadow-md">
