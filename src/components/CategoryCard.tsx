...
const CategoryCard: React.FC = () =>{
    return(
        <div className="flex flex-row">
            ...
            <Link className="w-[250px] h-[150px] flex flex-col items-center justify-center border-[#9BECE1] border-[1px] rounded-lg gap-[10px] m-[10px] cursor-pointer transition duration-300 ease-in hover:bg-[#9BECE1]" href={"/school"}>
