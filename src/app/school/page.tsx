        ...
        <div className="w-full flex flex-col items-center gap-[20px]">
                ...
                <div className="w-full flex flex-col">
                    <div className="flex flex-col w-full">
                        <div className="flex flex-row justify-center items-center w-full">
                            {schoolData && <div className="ml-[auto] pr-[50px] absolute w-full flex flex-col">
                                <Link href={"/add"} className="ml-[auto] drop-shadow-lg drop-shadow-[#02886F] cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 20 20"><path fill="#02886F" d="M11 9V5H9v4H5v2h4v4h2v-4h4V9zm-1 11a10 10 0 1 1 0-20a10 10 0 0 1 0 20"/></svg></Link>
                            </div>}
                        </div>
                        <div className="w-full flex flex-col items-center gap-[20px]">
            ...
            {noTasks && <div className="flex flex-col items-center w-full">
                ...
                <div className="flex flex-col gap-[10px] items-center mt-[50px] w-full justify-center">
                    ...
                    <Link href={"/add"} className="p-2 bg-[#4DAB9A] rounded-[10px] w-[150px] items-center flex flex-col transition duration-300  text-[#fff] ease-in hover:bg-[#02886F] hover:shadow-md hover:shadow-[#8e918f]">Add Task</Link>
                </div>
                </div>}
        </div>
    )
